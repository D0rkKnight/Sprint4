...
namespace TwoPm.TooltipDemo
{
    ...
    public class PointerViewController : MonoBehaviour
    {
        ...
        void Start() {
            ...
            TooltipSubsystemManager Control = TooltipSubsystemManager.Instance;
        ...
        void LateUpdate() {
            ...
            // Seems to be in world position or smth
            TooltipSubsystemManager Control = TooltipSubsystemManager.Instance;
            var newPos = Control.Camera.ScreenToWorldPoint(_pointerPosition + Offset); // TODO: consider  * _settings.Settings.UiScale here
            newPos.z = -5;
